...
if($_POST){
	...
	$query="INSERT INTO logarse(idJugador, DNI, Nom, Cognom, User, Password, Foto, online) VALUES (0, '".$d."', '".$_POST['nom']."', '".$c."', '".$u."', '".$p."', '".$f."',0)";  //Creamos la consulta
